...
Title.prototype.Create = function(doc)
{
   ...
   this.rec.setAttribute("style", "stroke:black;fill:#eeeeee;stroke-width:1");

   this.str = doc.createTextNode("");

   this.txt = doc.createElement("text")
   this.txt.setAttribute("style", "Open Sans Condensed', sans-serif; font-size:" + Title.size + ";fill:#eeeeee;");
...
Title.Zoom = function Title_Zoom(evt)
{
   ...
   window.svgTitle.rec.setAttribute("height", 2.25*Title.size);
   window.svgTitle.rec.setAttribute("style", "stroke:gray;fill:#eeeeee;stroke-width:" + 2/Title.scl);
   window.svgTitle.txt.setAttribute("style", "Open Sans Condensed', sans-serif; font-size:" + Title.size + ";fill:black;");
}
